...
public class MenuTestDrive {
    ...
    private static MenuComponent createAllMenus() {
        ...
        dinerMenu.add(createDesertMenu());

        MenuComponent cafeMenu = createCafeMenu();
        cafeMenu.add(createCoffeeMenu());

        MenuComponent allMenus = new Menu("ALL MENUS", "All menus combined");
        allMenus.add(createPancakeHouseMenu());
    ...
    private static MenuComponent createCoffeeMenu() {
    ...
    private static MenuComponent createDesertMenu() {
